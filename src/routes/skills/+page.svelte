<script lang="ts">
	...
	const skills = $state<Array<Skill>>([
		...
		},
		{
			...
			items: [
				{ tag: 'Problem Solving', colour: 'green' },
				{ tag: 'Teamwork', colour: 'purple' }
			]
		}
	]);
</script>

<section class="mb-2 w-full px-2 py-2">
	<div class="columns-1 md:columns-2 gap-4 max-h-[1000px] overflow-auto">

...
export const badgeColorMap: Record<string, string> = {
	...
	blue_light: 'bg-blue-400 hover:bg-blue-500 text-blue-950',
	blue: 'bg-blue-600 hover:bg-blue-700 text-white',
	blue_deep: 'bg-blue-800 hover:bg-blue-900 text-white',
	go: 'bg-[#00ABD7] hover:bg-[#0096be] text-white',
	sky: 'bg-sky-300 hover:bg-sky-400 text-sky-950',
	green: 'bg-green-500 hover:bg-green-600 text-white',
	emerald: 'bg-emerald-700 hover:bg-emerald-800 text-white',
	dark_blue: 'bg-blue-950 hover:bg-blue-900 text-white',
